...
@Component({
    ...
    <nz-dropdown nzPlacement="bottomRight">
        ...
        <div nz-menu-item (click)="userInfo()"><i nz-icon type="user" class="mr-sm"></i>个人中心</div>
        <div nz-menu-item (click)="changePwd()"><i nz-icon type="setting" class="mr-sm"></i>修改密码</div>
        <li nz-menu-divider></li>
        <div nz-menu-item (click)="logout()"><i nz-icon type="logout"  class="mr-sm"></i>退出登录</div>
        </div>
    </nz-dropdown>
  `,
})
