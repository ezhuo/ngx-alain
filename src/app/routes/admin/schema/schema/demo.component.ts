    ...
    this.mainSchema = {
      'properties': {
        ...
        'geo': {
          'type': 'string',
          'title': '所在地',
          'default': ['0003520.0000043.', '0003520.0000043.0000085.', '0003520.0000043.0000085.0000088.', '0003520.0000043.0000085.0000088.0006598.'],
          'ui': {
            widget: 'cascader',
            changeOnSelect: true,
            asyncData: (node) => {
              return this.caseSrv.nzCascaderLoadDataBySchema(node);
            },
            spanLabel: 2,
            spanControl: 22,
            'grid': {
